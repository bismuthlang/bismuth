...
tagBranch1:                                       ; preds = %entry
  ...
  %26 = load %_Channel*, %_Channel** %a, align 8
  %27 = call %Unit @_WriteChannel(%_Channel* %26, i8* %24)
...
tagBranch2:                                       ; preds = %entry
  ...
  %30 = call %Unit @_WriteProjection(%_Channel* %29, i32 2)
  %31 = load %_Channel*, %_Channel** %a, align 8
  %32 = call i8* @_ReadLinearChannel(%_Channel* %31)
  ...
  %38 = load %_Channel*, %_Channel** %b, align 8
  %39 = call %Unit @_WriteChannel(%_Channel* %38, i8* %36)
  %40 = call i8* @malloc(i32 8)
  %41 = bitcast i8* %40 to i8**
  store i8* getelementptr inbounds ([2 x i8], [2 x i8]* @2, i32 0, i32 0), i8** %41, align 8
  %42 = load %_Channel*, %_Channel** %a, align 8
  %43 = call %Unit @_WriteChannel(%_Channel* %42, i8* %40)

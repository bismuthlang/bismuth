...
tagBranch1:                                       ; preds = %entry
  ...
  %a1 = load %_Channel*, %_Channel** %a, align 8
  %b2 = load %_Channel*, %_Channel** %b, align 8
  %15 = call %Unit @linkRecvBool(%_Channel* %a1, %_Channel* %b2)
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @0, i32 0, i32 0))
  br label %match-cont

tagBranch2:                                       ; preds = %entry
  %17 = load %_Channel*, %_Channel** %b, align 8
  %18 = call %Unit @_WriteProjection(%_Channel* %17, i32 2)
  %a3 = load %_Channel*, %_Channel** %a, align 8
  %b4 = load %_Channel*, %_Channel** %b, align 8
  %19 = call %Unit @linkRecvInt(%_Channel* %a3, %_Channel* %b4)

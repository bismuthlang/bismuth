...
entry:
  ...
  %2 = call ptr @_Execute(ptr @toDecimal)
  store ptr %2, ptr %printer, align 8
  %3 = call ptr @getBinaryStreamFor(i32 120)
  %4 = call ptr @malloc(i32 8)
  store ptr %3, ptr %4, align 8
  %5 = load ptr, ptr %addStream, align 8
  %6 = call %Unit @_WriteChannel(ptr %5, ptr %4)
  %7 = call ptr @getBinaryStreamFor(i32 75)
  %8 = call ptr @malloc(i32 8)
  store ptr %7, ptr %8, align 8
  %9 = load ptr, ptr %addStream, align 8
  %10 = call %Unit @_WriteChannel(ptr %9, ptr %8)
  %addStream1 = load ptr, ptr %addStream, align 8
  %11 = call ptr @malloc(i32 8)
  store ptr %addStream1, ptr %11, align 8
  %12 = load ptr, ptr %printer, align 8
...
define ptr @getBinaryStreamFor(i32 %0) {
entry:
  %c = alloca ptr, align 8
  %n = alloca i32, align 4
  store i32 %0, ptr %n, align 4
  %1 = call ptr @_Execute(ptr @toBinary)

...
entry:
  ...
  %4 = load %IntBoxBox, ptr %3, align 4
  %5 = call %Unit @free(ptr %3)
  store %IntBoxBox %4, ptr %ib, align 4
  %6 = call i32 (ptr, ...) @printf(ptr @4)
  %7 = getelementptr %IntBoxBox, ptr %ib, i32 0, i32 0, i32 0
  %8 = load i32, ptr %7, align 4
  %9 = call i32 (ptr, ...) @printf(ptr @5, i32 %8)
  %10 = getelementptr %IntBoxBox, ptr %ib, i32 0, i32 0, i32 0
  store i32 20, ptr %10, align 4
  %11 = getelementptr %IntBoxBox, ptr %ib, i32 0, i32 0, i32 0

...
%"LinkedList<boolean>" = type { %"(Box<LinkedList<boolean>> + Empty)", i1, %"(Empty + LinkedList<str> + boolean)", %"(Empty + LinkedList<str>)" }
...
%"LinkedList<int>" = type { %"(Box<LinkedList<int>> + Empty)", i32, %"(Empty + LinkedList<str> + int)", %"(Empty + LinkedList<str>)" }
...
entry:
  ...
  %ll2 = alloca %"LinkedList<boolean>", align 8
  %ll = alloca %"LinkedList<int>", align 8

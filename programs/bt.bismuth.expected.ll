...
define %Unit @printPadding(i32 %0) {
entry:
...
tagBranch1:                                       ; preds = %entry
  ...
  %16 = call %Unit @traversePreOrder(i32 0, ptr @3, %BinaryTree %15)
  br label %match-cont
...
tagBranch13:                                      ; preds = %match-cont
  ...
  %26 = call %Unit @traversePreOrder(i32 0, ptr @4, %BinaryTree %25)
  br label %match-cont5
...
entry:
  ...
  %5 = call %Unit @printPadding(i32 %padding1)
...
tagBranch1:                                       ; preds = %entry
  ...
  %21 = call %Unit @traversePreOrder(i32 %19, ptr @8, %BinaryTree %20)
  br label %match-cont
...
tagBranch16:                                      ; preds = %match-cont
  ...
  %32 = call %Unit @traversePreOrder(i32 %30, ptr @9, %BinaryTree %31)
  br label %match-cont9
...
entry:
  ...
  %1 = alloca %"(Box<BinaryTree> + Empty)", align 8
  %2 = alloca %"(Box<BinaryTree> + Empty)", align 8
  %3 = alloca %BinaryTree, align 8
  %4 = alloca %Empty, align 8
  %5 = alloca %Empty, align 8
  %c = alloca ptr, align 8
  store ptr %0, ptr %c, align 8
  %6 = load %Empty, ptr %5, align 1
  %7 = load %Empty, ptr %4, align 1
  %8 = getelementptr %BinaryTree, ptr %3, i32 0, i32 0
  store i32 5, ptr %8, align 4
  %9 = getelementptr %"(Box<BinaryTree> + Empty)", ptr %2, i32 0, i32 0
  store i32 2, ptr %9, align 4
  %10 = getelementptr %"(Box<BinaryTree> + Empty)", ptr %2, i32 0, i32 1
  store %Empty %6, ptr %10, align 1
  %11 = load %"(Box<BinaryTree> + Empty)", ptr %2, align 4
  %12 = getelementptr %BinaryTree, ptr %3, i32 0, i32 1
  ...
  store %Empty %7, ptr %14, align 1
  %15 = load %"(Box<BinaryTree> + Empty)", ptr %1, align 4
  %16 = getelementptr %BinaryTree, ptr %3, i32 0, i32 2
  store %"(Box<BinaryTree> + Empty)" %15, ptr %16, align 4
  %17 = load %BinaryTree, ptr %3, align 4
  %18 = call ptr @GC_malloc(i64 28)
  store %BinaryTree %17, ptr %18, align 4
  store ptr %18, ptr %node, align 8
  %node1 = load ptr, ptr %node, align 8
  %19 = load %BinaryTree, ptr %node1, align 4
  %20 = call %Unit @printBT(%BinaryTree %19)
  %node2 = load ptr, ptr %node, align 8
  %21 = call %Unit @insertBT(ptr %node2, i32 6)
  %node3 = load ptr, ptr %node, align 8
  %22 = load %BinaryTree, ptr %node3, align 4
  %23 = call %Unit @printBT(%BinaryTree %22)
  %node4 = load ptr, ptr %node, align 8
  %24 = call %Unit @insertBT(ptr %node4, i32 2)
  %node5 = load ptr, ptr %node, align 8
  %25 = load %BinaryTree, ptr %node5, align 4
  %26 = call %Unit @printBT(%BinaryTree %25)
  %node6 = load ptr, ptr %node, align 8
  %27 = call %Unit @insertBT(ptr %node6, i32 3)
  %node7 = load ptr, ptr %node, align 8
  %28 = load %BinaryTree, ptr %node7, align 4
  %29 = call %Unit @printBT(%BinaryTree %28)
  %node8 = load ptr, ptr %node, align 8
  %30 = call %Unit @insertBT(ptr %node8, i32 4)
  %node9 = load ptr, ptr %node, align 8
  %31 = load %BinaryTree, ptr %node9, align 4
  %32 = call %Unit @printBT(%BinaryTree %31)
  %node10 = load ptr, ptr %node, align 8
  %33 = call %Unit @insertBT(ptr %node10, i32 7)
  %node11 = load ptr, ptr %node, align 8
  %34 = load %BinaryTree, ptr %node11, align 4
  %35 = call %Unit @printBT(%BinaryTree %34)

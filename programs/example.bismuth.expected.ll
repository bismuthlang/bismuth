...
%"programs::example::Color" = type { i32, [12 x i8] }
%"(Color + Unit)" = type { i32, [16 x i8] }
%"programs::example::ColorHelper" = type { ptr, ptr, ptr }
%"(boolean + int + str)" = type { i32, [8 x i8] }
%"programs::example::HexColor" = type { ptr }
%"programs::example::HSVColor" = type { i32, i32, i32 }
%"programs::example::RGBColor" = type { i32, i32, i32 }
...
entry:
  ...
  %c.0 = alloca %"programs::example::Color", align 8
  %3 = alloca %"(Color + Unit)", align 8
  %4 = alloca %"(Color + Unit)", align 8
  %5 = alloca %"(Color + Unit)", align 8
  %io = alloca ptr, align 8
  %i = alloca i32, align 4
  %samples = alloca [3 x %"programs::example::Color"], align 8
  %sampleChannel = alloca ptr, align 8
  %helper = alloca %"programs::example::ColorHelper", align 8
  %6 = alloca %"programs::example::ColorHelper", align 8
  %c = alloca ptr, align 8
  store ptr %0, ptr %c, align 8
  %7 = getelementptr %"programs::example::ColorHelper", ptr %6, i32 0, i32 0
  store ptr @"program::getRGBColor", ptr %7, align 8
  %8 = getelementptr %"programs::example::ColorHelper", ptr %6, i32 0, i32 1
  store ptr @"program::getHSVColor", ptr %8, align 8
  %9 = getelementptr %"programs::example::ColorHelper", ptr %6, i32 0, i32 2
  store ptr @"program::getHexColor", ptr %9, align 8
  %10 = load %"programs::example::ColorHelper", ptr %6, align 8
  store %"programs::example::ColorHelper" %10, ptr %helper, align 8
  %11 = call ptr @_Execute(ptr @"programs::example::getSampleColors")
  store ptr %11, ptr %sampleChannel, align 8
  %helper1 = load %"programs::example::ColorHelper", ptr %helper, align 8
  %12 = call ptr @malloc(i32 24)
  store %"programs::example::ColorHelper" %helper1, ptr %12, align 8
  ...
  %17 = load [3 x %"programs::example::Color"], ptr %16, align 4
  %18 = call %Unit @free(ptr %16)
  store [3 x %"programs::example::Color"] %17, ptr %samples, align 4
...
loop:                                             ; preds = %match-cont, %entry
  %20 = call ptr @_Execute(ptr @"programs::example::toString")
...
define %Unit @"programs::example::getSampleColors"(ptr %0) {
entry:
  %rgbChan = alloca ptr, align 8
  %ans = alloca [3 x %"programs::example::Color"], align 8
  %helper = alloca %"programs::example::ColorHelper", align 8
  %io = alloca ptr, align 8
  store ptr %0, ptr %io, align 8
  %1 = load ptr, ptr %io, align 8
  %2 = call ptr @_ReadLinearChannel(ptr %1)
  %3 = load %"programs::example::ColorHelper", ptr %2, align 8
  %4 = call %Unit @free(ptr %2)
  store %"programs::example::ColorHelper" %3, ptr %helper, align 8
  %5 = getelementptr %"programs::example::ColorHelper", ptr %helper, i32 0, i32 0
  ...
  %17 = getelementptr [3 x %"programs::example::Color"], ptr %ans, i32 0, i32 0
  %18 = load ptr, ptr %rgbChan, align 8
  %19 = call ptr @_ReadLinearChannel(ptr %18)
  %20 = load %"programs::example::Color", ptr %19, align 4
  %21 = call %Unit @free(ptr %19)
  store %"programs::example::Color" %20, ptr %17, align 4
  %22 = getelementptr [3 x %"programs::example::Color"], ptr %ans, i32 0, i32 1
  %23 = getelementptr %"programs::example::ColorHelper", ptr %helper, i32 0, i32 1
  %24 = load ptr, ptr %23, align 8
  %25 = call %"programs::example::Color" %24(i32 128, i32 128, i32 128)
  store %"programs::example::Color" %25, ptr %22, align 4
  %26 = getelementptr [3 x %"programs::example::Color"], ptr %ans, i32 0, i32 2
  %27 = getelementptr %"programs::example::ColorHelper", ptr %helper, i32 0, i32 2
  %28 = load ptr, ptr %27, align 8
  %29 = call %"programs::example::Color" %28(ptr @0)
  store %"programs::example::Color" %29, ptr %26, align 4
  %ans1 = load [3 x %"programs::example::Color"], ptr %ans, align 4
  %30 = call ptr @malloc(i32 48)
  store [3 x %"programs::example::Color"] %ans1, ptr %30, align 4
  %31 = load ptr, ptr %io, align 8
  %32 = call %Unit @_WriteChannel(ptr %31, ptr %30)
  ret %Unit zeroinitializer
}

define %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %0) {
entry:
  %b = alloca i1, align 1
...
tagBranch1:                                       ; preds = %entry
  ...
  %12 = call ptr @"programs::example::printPrimitive::#lambda"(i1 %b4)
...
define %Unit @"programs::example::toString"(ptr %0) {
entry:
  %1 = alloca %"(boolean + int + str)", align 8
  %hex = alloca %"programs::example::HexColor", align 8
  %2 = alloca %"(boolean + int + str)", align 8
  %3 = alloca %"(boolean + int + str)", align 8
  %4 = alloca %"(boolean + int + str)", align 8
  %hsv = alloca %"programs::example::HSVColor", align 8
  %5 = alloca %"(boolean + int + str)", align 8
  %6 = alloca %"(boolean + int + str)", align 8
  %7 = alloca %"(boolean + int + str)", align 8
  %rgb = alloca %"programs::example::RGBColor", align 8
  %8 = alloca %"programs::example::Color", align 8
  %c = alloca %"programs::example::Color", align 8
...
tagBranch4:                                       ; preds = %entry
  ...
  %27 = call %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %26)
  br label %match-cont9
...
tagBranch3:                                       ; preds = %entry
  ...
  %33 = call %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %32)
  br label %match-cont9
...
tagBranch5:                                       ; preds = %entry
  ...
  %39 = call %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %38)
  br label %match-cont9

tagBranch1:                                       ; preds = %entry
  %40 = getelementptr %"(Color + Unit + boolean + int + str)", ptr %12, i32 0, i32 1
  %41 = load %"programs::example::Color", ptr %40, align 4
  store %"programs::example::Color" %41, ptr %c, align 4
  %c5 = load %"programs::example::Color", ptr %c, align 4
  store %"programs::example::Color" %c5, ptr %8, align 4
  %42 = getelementptr %"programs::example::Color", ptr %8, i32 0, i32 0
...
tagBranch36:                                      ; preds = %tagBranch1
  %44 = getelementptr %"programs::example::Color", ptr %8, i32 0, i32 1
  %45 = load %"programs::example::RGBColor", ptr %44, align 4
  store %"programs::example::RGBColor" %45, ptr %rgb, align 4
  ...
  %52 = call %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %51)
  ...
  %59 = call %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %58)
  ...
  %66 = call %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %65)
  %67 = call i32 (ptr, ...) @printf(ptr @10)
  br label %match-cont

tagBranch17:                                      ; preds = %tagBranch1
  %68 = getelementptr %"programs::example::Color", ptr %8, i32 0, i32 1
  %69 = load %"programs::example::HSVColor", ptr %68, align 4
  store %"programs::example::HSVColor" %69, ptr %hsv, align 4
  ...
  %76 = call %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %75)
  ...
  %83 = call %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %82)
  ...
  %90 = call %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %89)
  %91 = call i32 (ptr, ...) @printf(ptr @14)
  br label %match-cont

tagBranch28:                                      ; preds = %tagBranch1
  %92 = getelementptr %"programs::example::Color", ptr %8, i32 0, i32 1
  %93 = load %"programs::example::HexColor", ptr %92, align 8
  store %"programs::example::HexColor" %93, ptr %hex, align 8
  ...
  %100 = call %Unit @"programs::example::printPrimitive"(%"(boolean + int + str)" %99)
...
entry:
  %1 = alloca %"programs::example::Color", align 8
  %2 = alloca %"programs::example::RGBColor", align 8
  ...
  %15 = getelementptr %"programs::example::RGBColor", ptr %2, i32 0, i32 0
  store i32 %red1, ptr %15, align 4
  %16 = getelementptr %"programs::example::RGBColor", ptr %2, i32 0, i32 1
  ...
  %21 = load %"programs::example::Color", ptr %1, align 4
  %22 = call ptr @malloc(i32 16)
  store %"programs::example::Color" %21, ptr %22, align 4
...
define private %"programs::example::Color" @"program::getHSVColor"(i32 %0, i32 %1, i32 %2) {
entry:
  %3 = alloca %"programs::example::Color", align 8
  %4 = alloca %"programs::example::HSVColor", align 8
  ...
  %5 = getelementptr %"programs::example::HSVColor", ptr %4, i32 0, i32 0
  store i32 %h1, ptr %5, align 4
  %6 = getelementptr %"programs::example::HSVColor", ptr %4, i32 0, i32 1
  ...
  %11 = load %"programs::example::Color", ptr %3, align 4
  ret %"programs::example::Color" %11
}

define private %"programs::example::Color" @"program::getHexColor"(ptr %0) {
entry:
  %1 = alloca %"programs::example::Color", align 8
  %2 = alloca %"programs::example::HexColor", align 8
  %s = alloca ptr, align 8
  ...
  %7 = load %"programs::example::Color", ptr %1, align 4
  ret %"programs::example::Color" %7
}

declare ptr @_Execute(ptr)

define private ptr @"programs::example::printPrimitive::#lambda"(i1 %0) {
entry:

...
accessGTZ:                                        ; preds = %accessLTL
  ...
  %32 = getelementptr i32, ptr %3, i32 0, i32 0
...
accessAfter:                                      ; preds = %accessBad, %accessGTZ
  ...
  %39 = load %"(Unit + u32 -> Unit)", ptr %38, align 4
  switch %"(Unit + u32 -> Unit)" %39, label %match-cont [
...
accessGTZ:                                        ; preds = %accessLTL
  ...
  %16 = getelementptr i32, ptr %3, i32 0, i32 0
...
accessAfter:                                      ; preds = %accessBad, %accessGTZ
  ...
  %23 = load %"(Unit + u32 -> Unit)", ptr %22, align 4
  switch %"(Unit + u32 -> Unit)" %23, label %match-cont [
    i32 1, label %tagBranch1
    i32 2, label %tagBranch2
  ]
...
accessGTZ:                                        ; preds = %accessLTL
  ...
  %15 = getelementptr i32, ptr %3, i32 0, i32 0
...
accessBad:                                        ; preds = %accessLTL, %then
  %18 = getelementptr i32, ptr %2, i32 0, i32 0
...
accessAfter:                                      ; preds = %accessBad, %accessGTZ
  ...
  %22 = load %"(Unit + str)", ptr %21, align 4
  switch %"(Unit + str)" %22, label %match-cont [
    i32 2, label %tagBranch2
    i32 1, label %tagBranch1
  ]
...
accessAfter:                                      ; preds = %accessBad, %accessGTZ
  ...
  %39 = load %"(Unit + u32 -> u32)", ptr %38, align 4
  switch %"(Unit + u32 -> u32)" %39, label %match-cont [
    i32 1, label %tagBranch1
    i32 2, label %tagBranch2
  ]
...
accessAfter:                                      ; preds = %accessBad, %accessGTZ
  ...
  %23 = load %"(Unit + u32 -> u32)", ptr %22, align 4
  switch %"(Unit + u32 -> u32)" %23, label %match-cont [
    i32 1, label %tagBranch1
    i32 2, label %tagBranch2
  ]
...
accessAfter:                                      ; preds = %accessBad, %accessGTZ
  ...
  %22 = load %"(Unit + u32)", ptr %21, align 4
  switch %"(Unit + u32)" %22, label %match-cont [
    i32 2, label %tagBranch2
    i32 1, label %tagBranch1
  ]

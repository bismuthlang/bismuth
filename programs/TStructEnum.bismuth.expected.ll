...
entry:
  ...
  %11 = getelementptr %ETIBBOB, ptr %toSend, i32 0, i32 0
  store i32 1, ptr %11, align 4
  %12 = getelementptr %ETIBBOB, ptr %toSend, i32 0, i32 1
  store %TIBB %tibb2, ptr %12, align 8
  %tibb3 = load %TIBB, ptr %tibb, align 8
  %13 = call %Unit @printTIBB(ptr @4, %TIBB %tibb3)
  %toSend4 = load %ETIBBOB, ptr %toSend, align 4
  %14 = call ptr @_address_map_create()
  %15 = call %ETIBBOB @_clone_ETIBBOB(%ETIBBOB %toSend4, ptr %14)
  %16 = call %Unit @_address_map_delete(ptr %14)
  %17 = call ptr @malloc(i32 20)
  store %ETIBBOB %15, ptr %17, align 4
  ...
  %24 = call %Unit @printTIBB(ptr @5, %TIBB %tibb5)
  ...
  %26 = call %Unit @printTIBB(ptr @6, %TIBB %tibb7)
  %27 = sub nsw i32 0, 1
  ...
  %35 = getelementptr %TIBB, ptr %1, i32 0, i32 0
  store ptr %shared.08, ptr %35, align 8
  %36 = getelementptr %TIBB, ptr %1, i32 0, i32 1
  store ptr %shared.09, ptr %36, align 8
  %37 = load %TIBB, ptr %1, align 8
  store %TIBB %37, ptr %tibb.0, align 8
  %tibb.010 = load %TIBB, ptr %tibb.0, align 8
  %38 = getelementptr %ETIBBOB, ptr %toSend.0, i32 0, i32 0
  store i32 1, ptr %38, align 4
  %39 = getelementptr %ETIBBOB, ptr %toSend.0, i32 0, i32 1
  store %TIBB %tibb.010, ptr %39, align 8
  %tibb.011 = load %TIBB, ptr %tibb.0, align 8
  %40 = call %Unit @printTIBB(ptr @8, %TIBB %tibb.011)
  %toSend.012 = load %ETIBBOB, ptr %toSend.0, align 4
  %41 = call ptr @_address_map_create()
  %42 = call %ETIBBOB @_clone_ETIBBOB(%ETIBBOB %toSend.012, ptr %41)
  %43 = call %Unit @_address_map_delete(ptr %41)
  %44 = call ptr @malloc(i32 20)
  store %ETIBBOB %42, ptr %44, align 4
  ...
  %51 = call %Unit @printTIBB(ptr @9, %TIBB %tibb.013)
  ...
  %53 = call %Unit @printTIBB(ptr @10, %TIBB %tibb.015)
  %54 = sub nsw i32 0, 1

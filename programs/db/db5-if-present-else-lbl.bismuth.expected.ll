...
tagBranch2:                                       ; preds = %loop
  ...
  %32 = getelementptr [10 x %Value], ptr %data, i32 0, i32 %k2
...
tagBranch3:                                       ; preds = %loop
  ...
  %38 = call ptr @_ReadLinearChannel(ptr %37)
  %39 = load i32, ptr %38, align 4
  %40 = call %Unit @free(ptr %38)
  %41 = getelementptr [10 x %Value], ptr %data, i32 0, i32 %39
...
ai-then:                                          ; preds = %ai-cond
  ...
  %14 = call %Unit @_WriteProjection(ptr %13, i32 3)
...
tagBranch2:                                       ; preds = %rest
  ...
  %51 = call %Unit @_WriteProjection(ptr %50, i32 3)
...
tagBranch3:                                       ; preds = %rest
  ...
  %68 = call %Unit @_WriteProjection(ptr %67, i32 2)
...
loop6:                                            ; preds = %loop6, %rest5
  ...
  %110 = call %Unit @_WriteProjection(ptr %109, i32 3)

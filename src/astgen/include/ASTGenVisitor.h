...
class ASTGenVisitor : public BismuthBaseVisitor
{
...
public:
     ...
     */
    ASTGenVisitor(STManager *s, int f = 0)
    {
        stmgr = s;
    ...
    std::variant<RawCompilationUnit *, ErrorChain *> visitCtx(BismuthParser::CompilationUnitContext *ctx);

...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/doubleArg2.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
    "Re-use of previously defined parameter a"
  );
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/doubleArg3.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
    "Re-use of previously defined parameter a"
  );
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/test15.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/test16.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
    "Redeclaration of c"
  );
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/test16a.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
    "Redeclaration of c"
  );
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/test16c.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
    "Redeclaration of c"
  );
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/test16c-1.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
    "Redeclaration of c"
  );
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/test16c-2.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
    "Redeclaration of c"
  );
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/test16d.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
    "Redeclaration of c"
  );
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/test16e.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/forwardWrongArg.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
    "Unsupported redeclaration of foo"
  );
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/forwardWrongArg2.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/BLevel/BNegative1.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/BLevel/BNegative2.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
...
{
  auto stream = std::fstream(std::string(SOURCE_DIR) + "programs/ALevel/ANegative2.bismuth");
  EnsureErrorsWithMessage(
    antlr4::ANTLRInputStream(stream),
